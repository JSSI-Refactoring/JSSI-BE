...
export class  $npmConfigName1699432092276 implements MigrationInterface {
    name = ' $npmConfigName1699432092276'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX \`IDX_d0f74a31e1840362c8b26d4e82\` ON \`User\``);
